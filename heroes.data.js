...
(function (root) {
  ...
  var HERO_DATA = [
    ...
    { id: "a0t0", arm: "Banque", module: "Banque", emoji: "🏦", name: "Mme Caution", rarity: 0, klass: "Market Maker", regime: "CRABE",
    ...
    { id: "a0t1", arm: "Banque", module: "Crédit", emoji: "💳", name: "Le Courtier", rarity: 1, klass: "Momentum", regime: "BULL",
      ...
      synergies: ["arm_banque"] },
    { id: "a0t2", arm: "Banque", module: "Trésorerie", emoji: "🏛️", name: "Le Trésorier", rarity: 2, klass: "Diamond Hands", regime: "CRASH",
    ...
    { id: "a1t0", arm: "Bourse", module: "Bourse", emoji: "📈", name: "Le Floor Trader", rarity: 0, klass: "Momentum", regime: "BULL",
      passive: { family: "A", text: "×1.25 production du module", effect: { type: "mult", value: 1.25, scope: "module" } },
      signature: { name: "Volume", text: "×3 production du module pendant 15 s", cooldown: 120 },
      synergies: ["arm_bourse", "speculation"] },
    { id: "a1t1", arm: "Bourse", module: "Crypto", emoji: "🪙", name: "Le Degen", rarity: 1, klass: "Degen", regime: "HYPE",
      ...
      synergies: ["arm_bourse", "speculation"] },
    { id: "a1t2", arm: "Bourse", module: "Hedge Fund", emoji: "🐋", name: "La Baleine", rarity: 2, klass: "Short Seller", regime: "BEAR",
    ...
    { id: "a2t0", arm: "Immobilier", module: "Immobilier", emoji: "🏠", name: "Le Bailleur", rarity: 0, klass: "Market Maker", regime: "CRABE",
    ...
    { id: "a2t1", arm: "Immobilier", module: "Promotion", emoji: "🏗️", name: "Le Promoteur", rarity: 1, klass: "Momentum", regime: "BULL",
      ...
      synergies: ["arm_immo", "briques"] },
    { id: "a2t2", arm: "Immobilier", module: "Gratte-ciel", emoji: "🌆", name: "Le Magnat", rarity: 2, klass: "Momentum", regime: "BULL",
    ...
    { id: "a3t0", arm: "Industrie", module: "Industrie", emoji: "🏭", name: "Le Contremaître", rarity: 0, klass: "Quant", regime: null,
      passive: { family: "A", text: "×1.25 production du module", effect: { type: "mult", value: 1.25, scope: "module" } },
      signature: { name: "Cadence", text: "×3 production du module pendant 15 s", cooldown: 120 },
      synergies: ["arm_indus", "briques"] },
    { id: "a3t1", arm: "Industrie", module: "Commerce", emoji: "🚢", name: "L'Armateur", rarity: 1, klass: "Market Maker", regime: "CRABE",
      ...
      synergies: ["arm_indus"] },
    { id: "a3t2", arm: "Industrie", module: "Aérospatial", emoji: "🛰️", name: "L'Ingénieure", rarity: 2, klass: "Diamond Hands", regime: "CRASH",
    ...
    { id: "a4t0", arm: "Startup", module: "Startup", emoji: "💼", name: "Le Founder", rarity: 0, klass: "Degen", regime: "HYPE",
    ...
    { id: "a4t1", arm: "Startup", module: "Licorne", emoji: "🦄", name: "La VC", rarity: 1, klass: "Momentum", regime: "BULL",
    ...
    { id: "a4t2", arm: "Startup", module: "Conglomérat", emoji: "🌍", name: "Le PDG", rarity: 2, klass: "Quant", regime: null,
    ...
    { id: "a5t0", arm: "Énergie", module: "Énergie", emoji: "🛢️", name: "Le Foreur", rarity: 0, klass: "Diamond Hands", regime: "CRASH",
    ...
    { id: "a5t1", arm: "Énergie", module: "Renouvelable", emoji: "⚡", name: "L'Écolo-tech", rarity: 1, klass: "Momentum", regime: "BULL",
    ...
    { id: "a5t2", arm: "Énergie", module: "Fusion", emoji: "☢️", name: "Le Physicien", rarity: 2, klass: "Degen", regime: "HYPE",
