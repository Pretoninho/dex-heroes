...
(function (root) {
  ...
  var HERO_DATA = [
    ...
    { id: "a0t0", arm: "Banque", module: "Banque", emoji: "🏦", name: "Jasper Norgan", rarity: 0, klass: "Market Maker", regime: "CRABE",
      ...
      signature: { name: "Intérêts", text: "Encaisse l'équivalent de 60 s de prod du module", cooldown: 120, effect: { kind: "cash", seconds: 60 } },
    ...
    { id: "a0t1", arm: "Banque", module: "Crédit", emoji: "💳", name: "Jamie Damone", rarity: 1, klass: "Momentum", regime: "BULL",
      ...
      signature: { name: "Levier", text: "×2 production du bras pendant 20 s", cooldown: 180, effect: { kind: "prod", scope: "arm", value: 2, duration: 20 } },
      synergies: ["arm_banque"] },
    { id: "a0t2", arm: "Banque", module: "Trésorerie", emoji: "🏛️", name: "Mayer Roschild", rarity: 2, klass: "Diamond Hands", regime: "CRASH",
      ...
      signature: { name: "Planche à billets", text: "Gros coup de cash instantané", cooldown: 300, effect: { kind: "cash", seconds: 600 } },
      synergies: ["arm_banque"] },

    // Bras Bourse 📈 — spéculation
    { id: "a1t0", arm: "Bourse", module: "Bourse", emoji: "📈", name: "Warden Buffott", rarity: 0, klass: "Momentum", regime: "BULL",
      passive: { family: "A", text: "×1.25 production du module", effect: { type: "mult", value: 1.25, scope: "module" } },
      signature: { name: "Volume", text: "×3 production du module pendant 15 s", cooldown: 120, effect: { kind: "prod", scope: "module", value: 3, duration: 15 } },
    ...
    { id: "a1t1", arm: "Bourse", module: "Crypto", emoji: "🪙", name: "Satoshi Nakomito", rarity: 1, klass: "Degen", regime: "HYPE",
      ...
      signature: { name: "FOMO", text: "Pluie de clics auto pendant 20 s", cooldown: 180, effect: { kind: "auto", value: 10, duration: 20 } },
      synergies: ["arm_bourse", "speculation"] },
    { id: "a1t2", arm: "Bourse", module: "Hedge Fund", emoji: "🐋", name: "Georg Solros", rarity: 2, klass: "Short Seller", regime: "BEAR",
      ...
      signature: { name: "Pump", text: "×5 production globale pendant 10 s", cooldown: 300, effect: { kind: "prod", scope: "global", value: 5, duration: 10 } },
      synergies: ["arm_bourse", "speculation"] },
    ...
    { id: "a2t0", arm: "Immobilier", module: "Immobilier", emoji: "🏠", name: "Sam Zello", rarity: 0, klass: "Market Maker", regime: "CRABE",
      ...
      signature: { name: "Loyers", text: "Encaisse une avance de loyer", cooldown: 150, effect: { kind: "cash", seconds: 120 } },
    ...
    { id: "a2t1", arm: "Immobilier", module: "Promotion", emoji: "🏗️", name: "Stephen Rolss", rarity: 1, klass: "Momentum", regime: "BULL",
      ...
      signature: { name: "Chantier", text: "×2 production du bras pendant 25 s", cooldown: 180, effect: { kind: "prod", scope: "arm", value: 2, duration: 25 } },
      synergies: ["arm_immo", "briques"] },
    { id: "a2t2", arm: "Immobilier", module: "Gratte-ciel", emoji: "🌆", name: "Donald Trumb", rarity: 2, klass: "Momentum", regime: "BULL",
      ...
      signature: { name: "Empire", text: "×4 production globale pendant 12 s", cooldown: 300, effect: { kind: "prod", scope: "global", value: 4, duration: 12 } },
      synergies: ["arm_immo", "briques"] },
    ...
    { id: "a3t0", arm: "Industrie", module: "Industrie", emoji: "🏭", name: "Henry Frod", rarity: 0, klass: "Quant", regime: null,
      passive: { family: "A", text: "×1.25 production du module", effect: { type: "mult", value: 1.25, scope: "module" } },
      signature: { name: "Cadence", text: "×3 production du module pendant 15 s", cooldown: 120, effect: { kind: "prod", scope: "module", value: 3, duration: 15 } },
    ...
    { id: "a3t1", arm: "Industrie", module: "Commerce", emoji: "🚢", name: "Aristote Onissas", rarity: 1, klass: "Market Maker", regime: "CRABE",
      ...
      signature: { name: "Convoi", text: "×2 production en aval pendant 25 s", cooldown: 180, effect: { kind: "prod", scope: "downstream", value: 2, duration: 25 } },
      synergies: ["arm_indus"] },
    ...
    { id: "a4t2", arm: "Startup", module: "Conglomérat", emoji: "🌍", name: "Geoff Bezus", rarity: 2, klass: "Quant", regime: null,
      ...
      signature: { name: "Fusion-acquisition", text: "Active toutes les synergies pendant 15 s", cooldown: 300, effect: { kind: "prod", scope: "global", value: 1.5, duration: 15 } },
      synergies: ["arm_startup"] },
    ...
    { id: "a5t0", arm: "Énergie", module: "Énergie", emoji: "🛢️", name: "John Lockefeller", rarity: 0, klass: "Diamond Hands", regime: "CRASH",
      ...
      signature: { name: "Gisement", text: "Double le stock idle accumulé", cooldown: 240, effect: { kind: "cash", seconds: 600 } },
    ...
    { id: "a5t1", arm: "Énergie", module: "Renouvelable", emoji: "⚡", name: "Elron Tusk", rarity: 1, klass: "Momentum", regime: "BULL",
      ...
      signature: { name: "Réseau", text: "×2 production des Rares pendant 20 s", cooldown: 180, effect: { kind: "prod", scope: "rarity", rarity: 1, value: 2, duration: 20 } },
    ...
    { id: "a5t2", arm: "Énergie", module: "Fusion", emoji: "☢️", name: "Bill Gatts", rarity: 2, klass: "Degen", regime: "HYPE",
      ...
      signature: { name: "Réaction en chaîne", text: "×8 production pendant 8 s", cooldown: 360, effect: { kind: "prod", scope: "global", value: 8, duration: 8 } },
      synergies: ["arm_energie", "deeptech"] }
  ];
