...
du héros) : **1️⃣ Invoquer** (acheter gemmes au cash + invoquer fragments — `pullFrags` ×1/×10/×100/**Max**) · **2️⃣ Renforcer** (Fusionner = +1 %/niv
...
- **Shell** : **en-tête permanent 2 rangées** (`.appheader` flex column) — R1 avatar + pseudo + (rang Valo
  ...
  Réglages** ; R2 chips **💵 cash** · **💎 gemmes (bouton → modale d'achat `#gemsOv` : +100/+1000/+10000/**Max** via `buyGems`)** · **📈 Promotion** (Valo,
